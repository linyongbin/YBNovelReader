...
-(void)viewDidLayoutSubviews
{
    ...
    self.charpterLabel.frame = CGRectMake(20, SafeAreaTop, self.view.width-40,40 );
    ...
    self.timeLabel.bottom = self.view.height-SafeAreaBottomHeight;
...
- (UILabel *)charpterLabel {
    if (!_charpterLabel){
        ...
        _charpterLabel.textColor = [YBReadConfigManager sharedInstance].samllCharpterColor;
        _charpterLabel.font = [UIFont systemFontOfSize:14];
...
- (RDBatteryView *)battery {
    if (!_battery){
        ...
        _battery.batteryColor = [YBReadConfigManager sharedInstance].toolColor;
...
- (UILabel *)progressLabel {
    if (!_progressLabel){
        ...
        _progressLabel.textColor = [YBReadConfigManager sharedInstance].toolColor;
...
- (UILabel *)timeLabel {
    if (!_timeLabel){
        ...
        _timeLabel.textColor = [YBReadConfigManager sharedInstance].toolColor;
...
-(UIImageView *)backgroundImageView
{
    if (!_backgroundImageView) {
        _backgroundImageView = [[UIImageView alloc] initWithImage:[YBReadConfigManager sharedInstance].background];
    }
...
-(UIImageView *)coverBackgroundImageVIew
{
    if (!_coverBackgroundImageVIew) {
        _coverBackgroundImageVIew = [[UIImageView alloc] initWithImage:[YBReadConfigManager sharedInstance].background];
