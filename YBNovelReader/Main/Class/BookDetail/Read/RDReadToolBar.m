...
-(void)layoutSubviews
{
    ...
    self.menu.frame = CGRectMake(0, 0, width, self.height-SafeAreaBottomHeight);
    self.slider.frame = CGRectMake(width, 0, width, self.height-SafeAreaBottomHeight);
    self.light.frame = CGRectMake(width*2, 0, width, self.height-SafeAreaBottomHeight);
    self.setting.frame = CGRectMake(width*3, 0, width,self.height-SafeAreaBottomHeight);
}
