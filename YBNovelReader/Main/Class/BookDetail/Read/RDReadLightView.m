...
-(RDToolSlider *)slider
{
    if (!_slider) {
        ...
        _slider.value = [YBReadConfigManager sharedInstance].brightness;
...
{
    [YBReadConfigManager sharedInstance].brightness = sender.value;
//    [[YBReadConfigManager sharedInstance] archive];
}
-(void)layoutSubviews
{
