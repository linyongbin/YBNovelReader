...
- (RDLayoutButton *)backBtn {
    if (!_backBtn) {
        RDLayoutButton *button = [[RDLayoutButton alloc] initWithFrame:CGRectMake(0, SafeAreaTop, 40, SafeAreaTopHeight)];
...
-(void)layoutSubviews
{
    ...
    self.question.frame = CGRectMake(0, SafeAreaTop, height, height);
    self.question.right = self.width;
    self.download.frame = CGRectMake(0, SafeAreaTop, height, height);
    self.download.right = self.question.left;
    self.reload.frame = CGRectMake(0, SafeAreaTop, height, height);
    self.reload.right = self.download.left;
    self.add.frame = CGRectMake(0, SafeAreaTop, height, height);
